...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{iteration_02/diagrams/lfs_server_all_enabled.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{iteration_02/diagrams/lfs_server_minimal.png}
    \caption{Git LFS Server}
