...
\begin{landscape}
    ...
    \begin{longtable}{|p{1cm}|p{19cm}|p{2cm}|p{3cm}|}
        ...
        \endhead
        %
        \rowcolor[HTML]{AAEEAA}        R1         & The system shall implement git and git-lfs repositories over SSH.                                                                                                                                                                                                                     &                       &                                          \\ \hline
        ...
        \rowcolor[HTML]{DDFFDD}        R4.5       & The system shall do regular backups of the data.                                                                                                                                                                                                                                      &                       &                                          \\ \hline
    \end{longtable}
\end{landscape}
